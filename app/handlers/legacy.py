...
async def get_missing_fields(user) -> List[str]:
    ...
    Возвращает список строк-идентификаторов:
...
async def ask_next_field(event: Union[MessageCreated, MessageCallback], context: MemoryContext, missing_fields: List[str]) -> None:
    """
